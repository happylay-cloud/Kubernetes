...
if [ $ret -ne 0 ]; then
   curl -sSL https://gitee.com/happylay/Kubernetes/raw/master/kubernetes%20v1.15.4/install-script/install_kubelet.sh | sh
else
   curl -sSL https://raw.githubusercontent.com/happylay-cloud/Kubernetes/master/kubernetes%20v1.15.4/install-script/install_kubelet.sh | sh
fi;
#-----------------------------------------------------------------------------------------------------------------------------
# 只在 worker 节点执行
